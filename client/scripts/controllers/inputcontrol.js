KApp.controller('InputController',  ['$scope', '$log', '$http', '$window', 'ClientService',function($scope, $log, $http, $window, $mdSidenav, $mdDialog, $mdMedia, ClientService) {
...
$scope.$watchCollection('inputData', function(newVal, oldVal){
    ...
    console.log("stuff", $scope.inputData.duplexBuy);
